...
export function validateRoomName(room) {
    validateNonEmptyString(room, 'room name', MAX_ROOM_NAME_LENGTH, (value, message) => new InvalidRoomNameError(value, message));
}
//# sourceMappingURL=room-name-validator.js.map