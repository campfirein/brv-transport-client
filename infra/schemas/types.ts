...
// ============================================================================
// Cipher Agent Event Types (cipher:*)
// ============================================================================
 ...
 */
export type TransportEventPayloadMap = TaskEventPayloadMap &
  LlmEventPayloadMap &
...
export type RequestResponseMap = {
  ...
  'session:switch': {request: SessionSwitchRequest; response: SessionSwitchResponse}
  'task:cancel': {request: TaskCancelRequest; response: TaskCancelResponse}
  'task:create': {request: TaskCreateRequest; response: TaskAck}
}
